...
dash -c "$(curl --create-dirs -fsSLo ~/.vim/colors/gruvbox-high-contrast.vim https://raw.githubusercontent.com/thetrotfreak/.files/main/.vim/colors/gruvbox-high-contrast.vim)"
...
dash -c "$(curl --create-dirs -fsSLo ~/.vim/colors/mac_classic.vim https://raw.githubusercontent.com/thetrotfreak/.files/main/.vim/colors/mac_classic.vim)"
dash -c "$(curl --create-dirs -fsSLo ~/.vim/colors/nord.vim https://raw.githubusercontent.com/thetrotfreak/.files/main/.vim/colors/nord.vim)"
